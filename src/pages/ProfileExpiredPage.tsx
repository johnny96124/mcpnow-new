        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="flex flex-col items-center justify-center h-full text-center py-16 px-4">
              ...
              <h1 className="text-3xl font-bold tracking-tight mb-3">This profile has expired</h1>
              
              <p className="text-lg text-muted-foreground max-w-md mb-8">
                The shared profile link you're trying to access is no longer available. 
                Profile links expire after 7 days for security reasons.
              </p>
              
              <div className="bg-muted/30 rounded-lg p-6 max-w-lg">
                <h3 className="font-medium mb-2">Why do shared links expire?</h3>
                <p className="text-sm text-muted-foreground">
                  For security and privacy reasons, all shared profile links in MCP Now have a 7-day expiration period. 
